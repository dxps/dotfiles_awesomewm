...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "Tab",
        function ()
            -- dxps> Changed to switch through all the non-minimized windows.
    ...
    -- dxps> Added to switch to any of the windows (incl minimized ones).
...
function awful.menu.new(args, parent)
    local ret = awful.menu.original_new(args,parent)
